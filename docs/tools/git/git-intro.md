...
![](./git-intro.assets/true-本地版本控制系统.png)
...
![](./git-intro.assets/true-集中化的版本控制系统.png)
...
![](./git-intro.assets/true-分布式版本控制系统.png)
...
![](./git-intro.assets/true-2019-3deltas.png)
...
![](./git-intro.assets/true-2019-3snapshots.png)
